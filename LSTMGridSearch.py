...
Xclin_train_search = np.array(search_train['read_code_seq_padded_end_idx_new_clin'].values)
Xclin_val_search = np.array(search_val['read_code_seq_padded_end_idx_new_clin'].values)
Xther_train_search = np.array(search_train['read_code_seq_padded_end_idx_new_ther'].values)
Xther_val_search = np.array(search_val['read_code_seq_padded_end_idx_new_ther'].values)
...
with tf.device('/GPU:0'):
    ...
    tuner.search([Xt_train_search, Xclin_train_search[:,:max_codes], Xther_train_search[:,:max_codes]], y_train_search, 
                 validation_data=([Xt_val_search, Xclin_val_search[:,:max_codes], Xther_val_search[:,:max_codes]], y_val_search),
                 epochs=5, 
                 batch_size = 128,
...
Xclin_train = np.array(trainingData['read_code_seq_padded_end_idx_new_clin'].values)
Xclin_val = np.array(validationData['read_code_seq_padded_end_idx_new_clin'].values)
Xclin_internaleval = np.array(internalEvaluationData['read_code_seq_padded_end_idx_new_clin'].values)
Xclin_eval = np.array(evaluationData['read_code_seq_padded_end_idx_new_clin'].values)
Xclin_eval_Wales = np.array(evaluationDataWales['read_code_seq_padded_end_idx_new_clin'].values)
Xclin_eval_Scotland = np.array(evaluationDataScotland['read_code_seq_padded_end_idx_new_clin'].values)
...
Xther_train = np.array(trainingData['read_code_seq_padded_end_idx_new_ther'].values)
Xther_val = np.array(validationData['read_code_seq_padded_end_idx_new_ther'].values)
Xther_internaleval = np.array(internalEvaluationData['read_code_seq_padded_end_idx_new_ther'].values)
Xther_eval = np.array(evaluationData['read_code_seq_padded_end_idx_new_ther'].values)
Xther_eval_Wales = np.array(evaluationDataWales['read_code_seq_padded_end_idx_new_ther'].values)
Xther_eval_Scotland = np.array(evaluationDataScotland['read_code_seq_padded_end_idx_new_ther'].values)
...
earlyStopping = EarlyStopping(monitor='val_auc', patience=5, verbose=0, mode='max', restore_best_weights=True)
mcp_save = ModelCheckpoint('../SeqModel/lstmv2.0AllParams1-bayesian-deeper-18+_'+set_vocab+'.weights.hdf5', save_best_only=True, monitor='val_auc', mode='max')
history = best_models.fit([Xt_train, Xclin_train[:,:max_codes], Xther_train[:,:max_codes]], y_train, 
                 validation_data=([Xt_val, Xclin_val[:,:max_codes], Xther_val[:,:max_codes]], y_val),
                          epochs=100, batch_size=128, class_weight=class_weight, callbacks = [earlyStopping])

pickle.dump(history, open('../SeqModel/history_lstmv2.0AllParams1-bayesian-deeper-18+_'+set_vocab+'.sav', 'wb'))
