...
vocab_all = pickle.load(open('../SeqModel/all_vocab_clinical_specific.sav', 'rb'))
...
###pocess each chunk
path = '../SeqModel/SeqChunks_clinical_specific/'
...
for file in files:
    ...
    pickle.dump(all_raw_data, open('../SeqModel/SeqChunks_clinical_specific/all_raw_data_indexed_' + str(chunk) +'.sav', 'wb'))
    chunk+=1
