...
all_data = pickle.load(open('../SeqModel/SeqChunks_clinical/all_raw_data_indexed_1.sav', 'rb'))[kept_columns]


for file in chunk_files:
    print(file)
    print(chunk)
    if (file != '../SeqModel/SeqChunks_clinical/all_raw_data_indexed_1.sav') & (chunk < 100):
...
all_data.to_feather('../SeqModel/all_data_clinical.feather')
