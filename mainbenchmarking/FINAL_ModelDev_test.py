...
model_folder = '../MODELS/TestResult/'
...
summary_result_internalVal.to_csv('../MODELS/internalValResult.csv', index_label=False, index=False)
...
summary_result_externalVal.to_csv('../MODELS/externalValResult.csv', index_label=False, index=False)
