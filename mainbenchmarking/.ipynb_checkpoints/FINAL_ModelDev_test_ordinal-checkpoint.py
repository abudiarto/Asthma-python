...
summary_result_internalVal.to_csv('../../MODELS/internalValResult_ordinal_new.csv', index_label=False, index=False)
...
summary_result_externalVal.to_csv('../../MODELS/externalValResult_ordinal_new.csv', index_label=False, index=False)
