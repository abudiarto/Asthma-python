...
n_splits = 10
model_folder = '../../MODELS/CrosVal_ordinal/'
...
for target_outcome in target_outcomes:
    ...
    for train_index, test_index in kf.split(X, y):
        ...
        for modelname, target_outcome, classratio in models_temp.values:
            # print('======================================================================')
            print(modelname)
            model = pickle.load(open('../../Models/CrosVal_ordinal/'+ target_outcome + '_'+ modelname + '.sav', 'rb'))       
...
summary_result_train.to_csv('../../MODELS/CrossVal_ordinal.csv', index_label=False, index=False)
