...
model_folder = '../../MODELS/TestResultOrdinal/'
...
summary_result_internalVal.to_csv('../../MODELS/internalValResult_ordinal.csv', index_label=False, index=False)
...
summary_result_externalVal.to_csv('../../MODELS/externalValResult_ordinal.csv', index_label=False, index=False)
