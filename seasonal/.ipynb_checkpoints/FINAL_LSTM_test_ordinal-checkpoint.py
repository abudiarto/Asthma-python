...
for target_outcome in target_outcomes:
    ...
    mcp_save = ModelCheckpoint('../../MODELS/TestResultOrdinal/lstm_tabseq.weights_simple_'+str(fold)+'.keras', save_best_only=True, monitor='val_auc', mode='max') #not needed in CV
    ...
    pickle.dump(history, open('../../MODELS/TestResultOrdinal/history_lstm_tabseq_simple_'+str(fold)+'.sav', 'wb'))
...
summary_result_internalVal.to_csv('../../MODELS/internalValResultLSTMOrdinal.csv', index_label=False, index=False)
...
summary_result_externalVal.to_csv('../../MODELS/externalValResultLSTMOrdinal.csv', index_label=False, index=False)
