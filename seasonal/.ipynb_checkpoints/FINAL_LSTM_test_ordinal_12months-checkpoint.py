...
####################################################################################################################################
    ## FCN before classification layer
        ...
        metrics = [
            AUC(num_thresholds=100, name='auc', curve='ROC'),
...
summary_result_internalVal.to_csv('../../MODELS/internalValResultLSTMOrdinal_12months.csv', index_label=False, index=False)
...
summary_result_externalVal.to_csv('../../MODELS/externalValResultLSTMOrdinal_12months.csv', index_label=False, index=False)
