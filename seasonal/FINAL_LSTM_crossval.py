...
for target_outcome in target_outcomes:
    ...
    for train_index, test_index in kf.split(crossVal_X, crossVal_y):
        ...
        mcp_save = ModelCheckpoint('../MODELS/lstm_tabseq.weights_simple_CV_'+str(fold)+'.keras', save_best_only=True, monitor='val_auc', mode='max') #not needed in CV
        ...
        pickle.dump(history, open('../MODELS/history_lstm_tabseq_simple_CV'+str(fold)+'.sav', 'wb'))
...
summary_result_train.to_csv('../MODELS/LSTM_simple.csv', index_label=False, index=False)
